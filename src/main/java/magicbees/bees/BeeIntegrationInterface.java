...
public final class BeeIntegrationInterface {
    ...
    //Thermal Expansion
    public static IAlleleEffect effectSpawnBlizz, effectSpawnBlitz, effectSpawnBasalz;
    ...
    //Thaumcraft
    public static AlleleFlowerProvider flowerAuraNode, flowersThaumcraft;
    public static IAlleleEffect effectNodeEmpower, effectNodeRepair, effectNodeConversionTaint, effectNodeConversionPure, effectNodeConversionHungry,
            effectVisRecharge, effectSpawnWhisp;
